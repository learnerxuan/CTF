...
void admin_access() {
    printf("Access granted to secure vault system.\n");
    printf("Retrieving classified data...\n");
    ...
    if (flag_file) {
        ...
        printf("Critical error: Secure data file not accessible.\n");
        printf("System integrity compromised. Terminating...\n");
        exit(1);
    }
}
...
int main() {
    ...
    printf("Welcome to the Digital Bank Vault System\n");
    printf("Secure account management interface v2.1\n\n");
